        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseDayRental = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    BaseKmPrice = table.Column<decimal>(type: "decimal(10,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickupMeterReadingKm = table.Column<int>(type: "int", nullable: false),
                    ReturnDateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ReturnMeterReadingKm = table.Column<int>(type: "int", nullable: true),
                    CalculatedPrice = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "CarCategory",
                columns: new[] { "Id", "BaseDayRental", "BaseKmPrice", "Name" },
                values: new object[,]
                {
                    { 1, 500m, 0m, "Small" },
                    { 2, 700m, 3m, "Combi" },
            ...
            migrationBuilder.InsertData(
                table: "Car",
                columns: new[] { "Id", "CarCategoryId", "RegistrationNumber" },
                values: new object[,]
                {
                    { 1, 1, "ABC123" },
                    { 2, 2, "DEF456" },
